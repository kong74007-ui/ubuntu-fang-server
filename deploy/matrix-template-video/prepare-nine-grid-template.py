...
#tagline{{left:55px;right:55px;top:auto;bottom:220px;height:auto;max-height:560px;display:block;text-align:center;white-space:pre;overflow-wrap:normal;word-break:keep-all;font-size:var(--bottom-font-size,58px);line-height:1.12;letter-spacing:0}}
