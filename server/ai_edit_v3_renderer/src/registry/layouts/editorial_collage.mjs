...
export function compileEditorialCollage(input) {
  ...
  const bodies = {
    magazine_grid: `<main class="hf-v2-magazine-grid"><header id="${prepared.prefix}_magazine_header" class="clip" ${clipAttributes(prepared.duration, 2)}><i></i><i></i></header><figure>${primary}</figure><aside>${detail}</aside><footer><b></b><b></b><b></b></footer></main>`,
