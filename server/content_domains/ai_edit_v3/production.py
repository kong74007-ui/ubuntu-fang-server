...
class QwenCompiledDirector:
    ...
    def _director_decision_system_prompt() -> str:
        ...
        return "\n".join((
            ...
            "For a repair, material_purpose_matches_selected_layout_semantic_slots means the target purpose must come from the selected layout's capabilities.layout_requirements semantic_slots. repair.constraint_envelope is authoritative timing and speaker-visibility data. When preserve_all_other_fields is true, change only the target_context purpose and preserve every other decision field.",
