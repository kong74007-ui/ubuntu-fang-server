...
async def lifespan(app: FastAPI):
    ...
    await external_audio.start_cleanup_scheduler()
    ...
    await external_audio.stop_cleanup_scheduler()
...
app.include_router(voice_assets_router, prefix=api_config.api_prefix)
