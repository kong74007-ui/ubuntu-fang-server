...
printf '{"ok":true,"build_id":"%s","records":1,"usage_state_ready":true,"selection_contract_version":2,"clip_contract_version":2}\n' "$build"
''')
        return fake
    ...
    def test_running_upgrade_loads_new_pid_and_exact_build(self):
        with tempfile.TemporaryDirectory() as temp:
            ...
            self.assertEqual(0o755, stat.S_IMODE((runtime / "source").resolve().stat().st_mode))
