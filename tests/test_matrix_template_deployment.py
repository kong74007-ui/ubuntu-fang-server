...
class MatrixTemplateDeploymentTests(unittest.TestCase):
    def test_installer_pins_skill_and_uses_atomic_release_contract(self):
        ...
        self.assertIn('REFERENCE_LAYOUT_PATCH_SHA256="7586af0e41fe83ca767d4dc4e969b748b7c19c8833de57fde2bd1354f261257d"', installer)
    ...
    def test_reference_patch_is_hash_locked_and_sets_all_top_offsets_to_eight_percent(self):
        ...
        self.assertEqual(
            "7586af0e41fe83ca767d4dc4e969b748b7c19c8833de57fde2bd1354f261257d",
        ...
        self.assertIn('font: 400 100px/1.08 "MaShan";', patch)
