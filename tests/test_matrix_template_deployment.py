...
class MatrixTemplateDeploymentTests(unittest.TestCase):
    def test_installer_pins_skill_and_uses_atomic_release_contract(self):
        ...
        self.assertIn('d.get("templates")==23', installer)
        ...
        self.assertIn('d.get("fixed_skill_templates")==["brush-panel-transitions","fan-whip-static","health-team-hook","triple-strip-shutter","yellow-banner-zoom"]', installer)
        self.assertIn('d.get("fixed_skill_template_count")==5', installer)
        self.assertIn('d.get("fixed_skill_hyperframes_version")=="mixed"', installer)
        self.assertIn('d.get("fixed_skill_hyperframes_versions")=={"0.8.33":2,"0.8.34":3}', installer)
