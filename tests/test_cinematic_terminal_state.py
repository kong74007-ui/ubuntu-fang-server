...
class CinematicResultShapeTests(unittest.TestCase):
    def _run(self):
        with patch.object(video, "get_video_avatar", return_value={"provider_avatar_id": "look1", "name": "我"}), \
             ...
             patch.object(video, "public_url", side_effect=lambda path, content_type=None, private=False:
                          "https://cos.example/video/out.mp4" if private else "https://cos.example/public"), \
    ...
    def test_result_prefers_cos_video_url(self):
