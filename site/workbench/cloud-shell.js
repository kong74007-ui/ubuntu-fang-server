...
(function(){
  ...
  var NAV=[
    ...
    {k:'video',l:'视频生成',i:'video'}, {k:'ai-edit',l:'一键剪辑',i:'edit'}, {k:'ai_edit_v2',l:'AI智能剪辑 V2',i:'edit',gated:'v2'}, {k:'ai_edit_v3',l:'AI智能剪辑 V3',i:'edit',gated:'v3'}, {k:'audio',l:'音频生成',i:'mic'}, {k:'script',l:'文案编导',i:'edit'},
  ...
  var NAV_PAGES={ai_edit_v2:'ai-edit-v2.html',ai_edit_v3:'ai-edit-v3.html'};
  ...
  function navHTML(active){
    var admin=isAdmin();
    return NAV.filter(function(it){ return (admin || !it.admin) && (!it.gated || (it.gated==='v2'?aiEditVisible:aiEditV3Visible)); }).map(function(it){
      var on=it.k===active;
